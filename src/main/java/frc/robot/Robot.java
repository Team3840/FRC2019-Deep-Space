...
import frc.robot.commands.HomeLift;
import frc.robot.subsystems.DriveTrain;
import frc.robot.subsystems.Elbow;
import frc.robot.subsystems.IntakeBall;
import frc.robot.subsystems.IntakeHatch;
...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    //Please don't move the OI instances creation!!!!
    oi = new OI();
  ...
  HomeLift autoHomeLift = new HomeLift();
    m_autonomousCommand = autoHomeLift;
